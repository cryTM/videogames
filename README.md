...
Exercise for creating websites from scratch.
...
* the JSON-server isn't running (the scores won't get displayed)
```

please do not request or suggest chances, I'm done for good with this project and ready to move on to greater things :)
...
* Thanks to my teacher and classmates
